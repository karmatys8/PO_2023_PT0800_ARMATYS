...
public class SimulationTest {
    ...
    public void doTests(String[] args, List<Vector2d> positions, Vector2d[] result, WorldMap worldMap) {
    ...
    public void testMove() {
        ...
        WorldMap worldMap1 = new RectangularMap(5, 5);
        ...
        WorldMap worldMap2 = new RectangularMap(4, 7);
        ...
        Vector2d[] result3 = {new Vector2d(1, 3), new Vector2d(1, 5), new Vector2d(0, 1),
                new Vector2d(1, 0), new Vector2d(0, 2), new Vector2d(0, 3), new Vector2d(0, 4),
                new Vector2d(1, 1)};
        WorldMap worldMap3 = new RectangularMap(2, 7);
        ...
        WorldMap worldMap4 = new RectangularMap(5, 5);
        ...
        WorldMap worldMap5 = new RectangularMap(1, 1);
        ...
        WorldMap worldMap6 = new RectangularMap(2, 3);
